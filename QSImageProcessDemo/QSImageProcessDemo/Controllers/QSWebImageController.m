...
@interface QSWebImageController ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
- (void)viewDidLoad {
    ...
    [self.collectionView registerClass:[QSWebImageCell class] forCellWithReuseIdentifier:@"QSWebImageCell"];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView
    ...
    QSWebImageCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"QSWebImageCell"
